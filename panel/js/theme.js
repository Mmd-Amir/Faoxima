(function () {
    ...
    try {
        if (!localStorage.getItem(COLOR_KEY) && typeof legacyColor !== 'undefined' && legacyColor) {
            localStorage.setItem(COLOR_KEY, legacyColor);
        }
        if (!localStorage.getItem(THEME_KEY) && typeof legacyTheme !== 'undefined' && legacyTheme) {
