...
final class CryptoCancelInvoiceHandler extends BaseHandler
{
    public function handle(): void
    {
        ...
        $cancellable = ['arze digital offline', 'plisio', 'nowpayment', 'digitaltron', 'cart to cart', 'carttocart_pv', 'iranpay2', 'tonpay', 'cubepay', 'blupal', 'variza', 'abangateway', 'atlaspay', 'tetrapay'];
