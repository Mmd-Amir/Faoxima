...
async function loadPendingBanner(view) {
    ...
    const externalGatewayPending = pending.find(p => p.method === 'iranpay2' || p.method === 'tonpay' || p.method === 'cubepay' || p.method === 'blupal' || p.method === 'variza' || p.method === 'abangateway' || p.method === 'atlaspay' || p.method === 'tetrapay');
